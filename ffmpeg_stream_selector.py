...
class StreamSelectorApp(QWidget):
    def __init__(self):
        ...
        self.update_streams_btn.setFlat(True)
        self.update_streams_btn.setStyleSheet("border: none; background: transparent;")
        self.update_streams_btn.setFixedSize(120, 50)
        self.update_streams_btn.setIconSize(self.update_streams_btn.size())
        ...
        self.convert_video_btn.setFlat(True)
        self.convert_video_btn.setStyleSheet("border: none; background: transparent;")
        self.convert_video_btn.setFixedSize(120, 50)
        self.convert_video_btn.setIconSize(self.convert_video_btn.size())
